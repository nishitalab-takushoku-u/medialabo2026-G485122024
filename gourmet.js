...
function print(data) {
  ...
  for(let r of data.results.shop){
    cnt = cnt + 1;
    console.log(cnt + "件名の検索結果");
    console.log("ジャンル: " + r.genre.name);
    console.log("サブジャンル: " + r.sub_genre.name);
    console.log("店名: " + r.name);
    console.log("住所: " + r.address);
    console.log("アクセス情報: " + r.access);
    console.log("キャッチコピー: " + r.catch);
    console.log("予算: " + r.budget.name);
    console.log("営業日時: " + r.open);
    console.log("最寄駅: " + r.station_name);
  }
}
